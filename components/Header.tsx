      ...
      <div className="max-w-5xl mx-auto px-4 h-24 flex items-center justify-between gap-4">
        ...
        <div className="flex flex-col justify-center gap-1 flex-1">
          ...
          <div className="flex items-center gap-1 pl-0.5 overflow-x-auto no-scrollbar max-w-full pb-1 sm:pb-0">
            ...
            <button onClick={onShowOwnerDetails} className="px-2 py-1.5 rounded-md hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-500 hover:text-indigo-500 transition-all shrink-0">
              <span className="text-[9px] font-black uppercase tracking-widest">Owner details</span>
            </button>
            <button onClick={onShowContact} className="px-2 py-1.5 rounded-md hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-500 hover:text-emerald-500 transition-all shrink-0 flex items-center gap-1">
              <span className="text-[9px] font-black uppercase tracking-widest">Contact</span>
            </button>
            <button onClick={onShowAbout} className="px-2 py-1.5 rounded-md hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-500 hover:text-cyan-500 transition-all shrink-0">
              <span className="text-[9px] font-black uppercase tracking-widest">About</span>
            </button>
            <button onClick={onShowHelp} className="px-2 py-1.5 rounded-md hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-500 hover:text-blue-500 transition-all shrink-0">
